...
for (i in loop_list){
  if (i == "data.0.CurrentU90-94"){
    ue_stack <- readRDS(paste0(importdir, "11-bls-unemployment/bls_unemployment_", i, ".Rds"))
  } else{
    temp <- readRDS(paste0(importdir, "11-bls-unemployment/bls_unemployment_", i, ".Rds"))
