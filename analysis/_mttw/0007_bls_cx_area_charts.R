...
folder_name <- "_mttw/0007_bls_cx_area_charts"
...
bls_cx_expenditures <-  bls_cx_expenditures %>%
                            ...
                            mutate(item_name = case_when(
                              item_name == "Food" ~ "食物",
                              item_name == "Housing" ~ "住房",
                              item_name == "Transportation" ~ "交通",
                              item_name == "Healthcare" ~ "醫療",
                              TRUE ~ ""
                            ))
