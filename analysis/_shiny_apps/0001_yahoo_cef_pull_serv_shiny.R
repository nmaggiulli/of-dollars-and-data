...
rsconnect::setAccountInfo(name='nmaggiulli',
                          token='see account for token',
                          secret='see account for secret')

# Set paths
shiny_path <- paste0("/Users/nmaggiulli/git/of_dollars_and_data/analysis/_shiny_apps/0001_shiny_yahoo_cef_pull/")
