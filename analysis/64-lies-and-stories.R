...
plot_beg_end <- function(stub, end_date_jpy, end_date_nasdaq, end_date_housing){

  # Bring in JPY Nikkei index data
  jpy   <- Quandl('NIKKEI/INDEX')
  
  to_plot    <-  filter(jpy, Date >= '1980-01-01', Date <= end_date_jpy) %>%
  ...
  end_year   <- as.Date(end_date_housing)
...
plot_beg_end("beg-", '1989-12-31', '1999-12-31', '2007-06-30')
plot_beg_end("end-", '2012-06-30', '2003-05-30', '2011-12-31')
