...
folder_name <- "0475_ideal_coast_fire"
out_path <- paste0(exportdir, folder_name)
dir.create(file.path(paste0(out_path)), showWarnings = FALSE)

########################## Start Program Here ######################### #

retire_amount <- 3.5*10^6
...
file_path <- paste0(out_path, "/coast_fire_3p5_million_final.jpeg")
source_string <- paste0("Source: Simulated data (OfDollarsAndData.com)")
note_string <-  str_wrap(paste0("Note: Assumes retirement occurs at age 65, your money compounds at ", 100*expected_return, "% per year after inflation, and ",
