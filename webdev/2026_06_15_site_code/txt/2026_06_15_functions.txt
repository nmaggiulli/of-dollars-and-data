...
function enqueue_custom_scripts() {
    // S&P 500 Calculator page (without Chart.js)
    if (is_page(23470)) {
        // Load Moment.js
        wp_enqueue_script('momentjs', 'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js', array(), '2.29.1', true);
        
        // Load S&P 500 calculator script (without Chart.js dependency)
        wp_enqueue_script('sp500_calculator', get_template_directory_uri() . '/sp500_calculator.js', array('momentjs'), '1.0.0', true);
    } 
    // All other calculator pages (with Chart.js)
    elseif (is_page(array(23619, 23693, 23727, 24987, 25023, 27697))) {
        // Load Moment.js
        wp_enqueue_script('momentjs', 'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js', array(), '2.29.1', true);
        ...
        // Load specific calculator scripts based on page
        if (is_page(23619)) {
