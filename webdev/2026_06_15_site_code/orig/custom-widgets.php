...
class A2_Networks_Widget extends WP_Widget {
    function A2_Networks_Widget() {
        ...
        $this->WP_Widget( 'a2_networks-widget', __('Aytoo Networks', 'custom'), $widget_ops, $control_ops );
    }
...
class A2_IC_Ad_Widget extends WP_Widget {
    function A2_IC_Ad_Widget() {
        $widget_ops = array( 'classname' => 'a2_ad widget', 'description' => __('Display an Investing Channel Ad', 'a2_ad') );
        $control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'a2_ad-widget' );
        $this->WP_Widget( 'a2_ad-widget', __('Aytoo Ad Display', 'custom'), $widget_ops, $control_ops );
    }
...
class Hot_Links_Widget extends WP_Widget {
    function Hot_Links_Widget() {
        ...
        $this->WP_Widget( 'hot_links-widget', __('Aytoo Recent Links', 'custom'), $widget_ops, $control_ops );
    }
...
class Best_Of_Widget extends WP_Widget {
    function Best_Of_Widget() {
        ...
        $this->WP_Widget( 'best_of-widget', __('Aytoo Best Of Posts', 'custom'), $widget_ops, $control_ops );
    }
